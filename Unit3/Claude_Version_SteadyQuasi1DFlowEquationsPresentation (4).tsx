    ...
    return (
      <svg viewBox="0 0 520 470" {...common}>
        <g key={run}>
          ...
          <path d={`M${xIn - 20} 50 C120 52 170 68 ${xThroat} 70 C250 72 300 55 ${xExit - 80} 50`} className="q1d-wall" />
          <path d={`M${xIn - 20} 90 C120 88 170 72 ${xThroat} 70 C250 68 300 85 ${xExit - 80} 90`} className="q1d-wall" />
    ...
    return (
      <svg viewBox="0 0 560 300" {...common}>
        <g key={run}>
          ...
          <text x={xOut + 6} y="102" className="q1d-t q1d-t--a">p_e4/p_t &hellip; sonic @ throat</text>
          <text x="70" y="88" className="q1d-t q1d-t--sm">max &#7745; \u2014 choked</text>

          {/* new, larger Pt ceiling */}
          <line x1={xIn} y1="46" x2={xOut} y2="46" className="q1d-vwall" strokeDasharray="3 5" />
          <text x={xOut + 6} y="50" className="q1d-t q1d-t--r">new (larger) P_t</text>
