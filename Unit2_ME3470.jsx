...
export const slides = [
  ...
  // ── EQUATION OF STATE: P = Z rho R T  ->  ideal gas law ────────────────────
  {
    ...
    equationLabel:
      'Properties like c<sub>p</sub>, c<sub>v</sub>, T, &rho;, and p drive every propulsion calculation. A general fluid carries a compressibility factor Z; set Z = 1 and you recover the ideal gas law:',
    ...
    items: [
      { title: 'Perfect gas: Z = 1', body: 'p = &rho;RT &mdash; the model your c<sub>p</sub>, c<sub>v</sub>, and energy relations are all built on.' },
  ...
  // ── WHEN THE IDEAL GAS LAW FAILS (high P: molecular volume; low T: forces) ─
  {
    ...
    closer:
      'Both effects are exactly what the van der Waals corrections capture. In this course they stay negligible &mdash; but this is the answer to the question the reservoir example raises: <em>here</em> is when you would reach for a real-gas equation of state.',
  },
