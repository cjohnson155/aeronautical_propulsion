    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, width: "100%" }}>
      ...
      <svg viewBox="0 0 680 310" style={{ width: "100%", maxWidth: 680, height: "auto", overflow: "visible" }}>
        <defs>
          ...
          {/* Tension: small head, used at BOTH ends of a tangential line.
              orient="auto-start-reverse" flips the start head so it points outward too. */}
          <marker id="pd-tension" markerWidth="7" markerHeight="7" refX="6" refY="3.5" orient="auto-start-reverse">
            <path d="M0,0 L0,7 L7,3.5 z" fill="#a8ff3e" />
          </marker>
              ...
              <>
                ...
                {showExt && (
                  <line x1={CX - RX - ARROW - 4} y1={CY} x2={CX - RX - 3} y2={CY}
                    stroke="#00d4ff" strokeWidth="3.2" markerEnd="url(#pd-ext)"
                ...
                <line x1={CX - RX + INT_ARROW} y1={CY} x2={CX - RX + 3} y2={CY}
                  stroke="#ff6b35" strokeWidth="4.2" markerEnd="url(#pd-int)"
