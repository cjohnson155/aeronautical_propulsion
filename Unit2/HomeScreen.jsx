// ME 3470 · Unit 2 — Home screen
// A clickable grid of section cards. Each card jumps to that section's first
// slide via onPick(section.start). Section data comes from ./slides/index.js.
