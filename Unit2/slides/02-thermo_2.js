...
export const thermoSlides = [
  ...
  // ── WHY THERMO? Treating compressible flow as incompressible ───────────────
  {
    ...
    equation: 'F = \\dot{m}\\,(V_e - V_i) + (p_e - p_i)\\,A_e',
  ...
  //  RELOCATED from Section 1 (was a premature thermo preview in the intro).
  {
    type: 'equation',
    ...
    items: [
      {
        ...
        body: 'Ideal gas law: p = RT/v = 49.2 atm. Van der Waals (a = 0.364 Pa·m⁶/mol², b = 4.267×10⁻⁵ m³/mol): '
          + 'p = RT/(v−b) − a/v² = 39.5 atm — about 20% lower than the ideal prediction.',
      },
      {
  ...
  // ── INTERNAL ENERGY & ENTHALPY EQUATIONS (relocated from Section 1) ──────────
  //  Gives the calorically-perfect-gas relations up front; the next three slides
  //  (energymodes / dof / cpcv) then explain the molecular "why" behind them.
  {
    type: 'equation',
  ...
  // ── WORKED EXAMPLE: INTERNAL ENERGY (Anderson MCF Ex. 2 — Part c) ───────────
  {
    ...
    scenario:
      'Same vessel: <strong>m = 235.4 kg, T = 300 K.</strong> '
    ...
    steps: [
      ...
      },
      {
        ...
        eq: 'E = mc_v T = (235.4)(717.5)(300)',
        result: 'E = 5.07\\times 10^7\\;\\mathrm{J}',
        revealResult: true,
      },
    ],
  },
